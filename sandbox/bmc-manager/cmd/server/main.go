...
import (
	...
	_ "github.com/example/bmc-manager/pkg/apiversion"
	"github.com/openchami/fabrica/pkg/versioning"
	 ...
	 "github.com/example/bmc-manager/internal/storage/ent/migrate"
	...
	. "github.com/example/bmc-manager/internal/middleware"
	

	
	"github.com/openchami/fabrica/pkg/reconcile"
	"github.com/example/bmc-manager/pkg/reconcilers"
...
var rootCmd = &cobra.Command{
	Use:   "bmc-manager",
	Short: "",
	Long:  `bmc-manager - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the bmc-manager server",
	Long:  `Start the bmc-manager HTTP server with the configured options`,
	RunE:  runServer,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.bmc-manager.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName(".bmc-manager")
	}

	// Environment variables
	viper.SetEnvPrefix("BMC-MANAGER")
	viper.AutomaticEnv()
...
func runServer(cmd *cobra.Command, args []string) error {
	log.Printf("Starting bmc-manager server...")
	...
	if eventConfig.EventTypePrefix == "" {
		eventConfig.EventTypePrefix = "bmc-manager.resource"
	}
...
func healthHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`{"status":"healthy","service":"bmc-manager"}`))
}
...
var versionCmd = &cobra.Command{
	...
	Long:  `Print the version number of bmc-manager`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("bmc-manager v1.0.0")
	},
}
