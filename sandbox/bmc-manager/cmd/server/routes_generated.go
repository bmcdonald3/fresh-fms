...
//   - /bmccredentials (BMCCredential operations)
//
// Route patterns:
...
func registerResourcePrefixes() error {
	...
	resource.RegisterResourcePrefix("BMCCredential", "bmccredential")
...
func RegisterGeneratedRoutes(r chi.Router) {
	...
	r.Group(func(protected chi.Router) {
		...
		// BMCCredential routes
		protected.Route("/bmccredentials", func(r chi.Router) {
			r.Get("/", GetBMCCredentials)
			r.Post("/", CreateBMCCredential)
			r.Route("/{uid}", func(r chi.Router) {
				r.Get("/", GetBMCCredential)
				r.Put("/", UpdateBMCCredential)
				r.Patch("/", PatchBMCCredential)
				r.Delete("/", DeleteBMCCredential)

				// Status subresource
				r.Route("/status", func(r chi.Router) {
					r.Put("/", UpdateBMCCredentialStatus)
					r.Patch("/", PatchBMCCredentialStatus)
				})
			})
		})
